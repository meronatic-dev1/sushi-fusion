...
export class SettingsService {
    ...
    async updateSettings(data: { logoUrl?: string; bannerUrl?: string; bannerUrls?: string[]; mobileBannerUrls?: string[]; serviceCharge?: number; enableServiceCharge?: boolean; enableServiceChargeTakeaway?: boolean; deliveryFee?: number; taxRate?: number }) {
