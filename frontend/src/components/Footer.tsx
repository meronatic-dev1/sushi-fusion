...
const SOCIAL = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/SushiFusionUAE',
    path: 'M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z',
  },
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/sushi_fusion_uae/',
  ...
  {
    label: 'TikTok',
    href: 'https://www.tiktok.com/@sushifusion1',
    path: 'M12.525.02c1.31 0 2.59.33 3.73.95V4.6a4.8 4.8 0 01-3.73-.95c-.24 1.5-.9 2.87-1.89 3.96a4.8 4.8 0 011.89-3.96V19.5a4.8 4.8 0 01-4.8 4.8 4.8 4.8 0 01-4.8-4.8 4.8 4.8 0 014.8-4.8c.64 0 1.25.13 1.8.35v-3.72A8.49 8.49 0 007.725 11a8.5 8.5 0 108.5 8.5v-9.15c2.3.83 4.3 2.37 5.75 4.32l.02-3.82c-2.31-.83-4.31-2.37-5.77-4.33V.02h-3.7z',
  },
];
